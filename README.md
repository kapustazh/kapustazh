# Matvii Nesterenko
**Systems, Web3 & Software Engineer · Low-Level Systems · AI Agent Tooling · Graph Algorithms**  
Heilbronn / Stuttgart, Germany · [work@kapustazh.dev](mailto:work@kapustazh.dev) · [kapustazh.dev](https://kapustazh.dev) · [LinkedIn](https://linkedin.com/in/matvii-nesterenko-1b723a278)
...
**Systems & Core:** Low-level programming · Graph theory & pathfinding · Algorithm optimization · POSIX standards · Memory management  
**AI & Web3:** MCP · RAG · Web3/DeFi Infrastructure  
**Stack & Tooling:** C · C++ · Python · TypeScript · SQL · Bash · FastAPI · Convex · Docker · Linux · Git  

---

## Highlights & Education

- 🏆 **ETHGlobal Lisbon 2026 Winner** — 3rd Place in The Graph's *Best AI Tooling* track for DeepTrace.
- 🎓 **42 Heilbronn** — Software Engineering student focusing on core systems programming and software architecture.

---

## Let's talk

Open to software engineering, systems, and Web3 roles.  
[work@kapustazh.dev](mailto:work@kapustazh.dev) · [kapustazh.dev](https://kapustazh.dev) · [LinkedIn](https://linkedin.com/in/matvii-nesterenko-1b723a278)
